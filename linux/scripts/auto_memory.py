#!/usr/bin/env python3
"""auto_memory.py for Linux — 自动记忆管理引擎
基于 ai-test-platform 的 local-memory v4 设计

用法：
  python auto_memory.py save <name> <entity_type> <observation> [memory_type]
  python auto_memory.py search <query>
  python auto_memory.py maintain
  python auto_memory.py stats
"""
